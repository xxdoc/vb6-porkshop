...
Begin VB.Form frmAddPayItem 
   ClientHeight    =   10380
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   13875
   Icon            =   "frmAddPayItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   Moveable        =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddPayItem.frx":27A2
         Column(2)       =   "frmAddPayItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddPayItem.frx":290E
         FormatStyle(2)  =   "frmAddPayItem.frx":2A6A
         FormatStyle(3)  =   "frmAddPayItem.frx":2B1A
         FormatStyle(4)  =   "frmAddPayItem.frx":2BCE
         FormatStyle(5)  =   "frmAddPayItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddPayItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddPayItem.frx":2F36
         Column(2)       =   "frmAddPayItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddPayItem.frx":30A2
         FormatStyle(2)  =   "frmAddPayItem.frx":31FE
         FormatStyle(3)  =   "frmAddPayItem.frx":32AE
         FormatStyle(4)  =   "frmAddPayItem.frx":3362
         FormatStyle(5)  =   "frmAddPayItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddPayItem.frx":34F2
      End
      Begin PorkShop.uctlTextBox txtKeySearch 
         Height          =   435
         Left            =   1860
         TabIndex        =   0
         Top             =   770
         ...
         _ExtentY        =   767
      End
      Begin PorkShop.uctlTextBox txtCustomer 
         Height          =   435
         Left            =   9405
         TabIndex        =   1
         Top             =   770
      ...
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddPayItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddPayItem.frx":39E4
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddPayItem.frx":3CFE
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddPayItem"
...
Dim Temp As Double
   ...
   While Not Rs.EOF
      ...
      Call BD.PopulateFromRS(1010, Rs)
      
      If Not IsIn(m_TempCol2, BD.BILLING_DOC_ID) Then
         
         If BD.DOCUMENT_TYPE = S_INVOICE_DOCTYPE Then
            BD.PAY_AMOUNT = BD.TOTAL_PRICE + BD.VAT_AMOUNT - (BD.DISCOUNT_AMOUNT + BD.EXT_DISCOUNT_AMOUNT + BD.PAID_AMOUNT)
         ElseIf BD.DOCUMENT_TYPE = S_RETURN_DOCTYPE Then
            BD.PAY_AMOUNT = BD.TOTAL_PRICE + BD.VAT_AMOUNT - (BD.DISCOUNT_AMOUNT + BD.EXT_DISCOUNT_AMOUNT + BD.PAID_AMOUNT)
         ElseIf BD.DOCUMENT_TYPE = S_CN_DOCTYPE Then 'จิวเพิ่มให้ใส่ VAT ด้วย ณ 04/10/2556
            If BD.PAID_AMOUNT > 0 Then
               BD.PAY_AMOUNT = 0
            Else
               BD.PAY_AMOUNT = BD.PAY_AMOUNT + BD.VAT_AMOUNT
            End If
         ElseIf BD.DOCUMENT_TYPE = S_DN_DOCTYPE Then
            If BD.PAID_AMOUNT > 0 Then
               BD.PAY_AMOUNT = 0
            Else
               BD.PAY_AMOUNT = BD.PAY_AMOUNT + BD.VAT_AMOUNT
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      m_BillingDoc.DOCUMENT_TYPE_SET = "(" & S_INVOICE_DOCTYPE & "," & S_RETURN_DOCTYPE & "," & S_CN_DOCTYPE & "," & S_DN_DOCTYPE & ")"
      If DocumentType = S_RECEIPT2_DOCTYPE Then
         m_BillingDoc.DOCUMENT_TYPE_RCP = S_RECEIPT2_DOCTYPE
      ElseIf DocumentType = S_BILLS_DOCTYPE Then
         m_BillingDoc.DOCUMENT_TYPE_RCP = S_BILLS_DOCTYPE
      End If
      m_BillingDoc.CANCEL_FLAG = "N"
      
      m_BillingDoc.SHOW_ALL_FLAG = Check2Flag(chkShowAll.Value)
      
      Call m_BillingDoc.QueryData(1010, m_Rs, ItemCount)
   End If
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblCustomer, MapText("รหัสผู้ค้า"))
