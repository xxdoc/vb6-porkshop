...
Begin VB.Form frmAddChequeItemEx 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddChequeItemEx.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   Moveable        =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddChequeItemEx.frx":27A2
         Column(2)       =   "frmAddChequeItemEx.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddChequeItemEx.frx":290E
         FormatStyle(2)  =   "frmAddChequeItemEx.frx":2A6A
         FormatStyle(3)  =   "frmAddChequeItemEx.frx":2B1A
         FormatStyle(4)  =   "frmAddChequeItemEx.frx":2BCE
         FormatStyle(5)  =   "frmAddChequeItemEx.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddChequeItemEx.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddChequeItemEx.frx":2F36
         Column(2)       =   "frmAddChequeItemEx.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddChequeItemEx.frx":30A2
         FormatStyle(2)  =   "frmAddChequeItemEx.frx":31FE
         FormatStyle(3)  =   "frmAddChequeItemEx.frx":32AE
         FormatStyle(4)  =   "frmAddChequeItemEx.frx":3362
         FormatStyle(5)  =   "frmAddChequeItemEx.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddChequeItemEx.frx":34F2
      End
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeItemEx.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeItemEx.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeItemEx.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeItemEx.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddChequeItemEx"
...
Private m_CashTran As CCashTran
...
Dim D As CCashTran
   ...
   For Each Ri In TempCollection
      ...
      D.CHEQUE_ID = Ri.GetFieldValue("CHEQUE_ID")
      D.CHEQUE_DATE = Ri.GetFieldValue("CHEQUE_DATE")
      D.CHEQUE_NO = Ri.GetFieldValue("CHEQUE_NO")
      D.CHEQUE_AMOUNT = Ri.GetFieldValue("CHEQUE_AMOUNT")
      D.BANK_ID = Ri.GetFieldValue("BANK_ID")
      D.BANK_NAME = Ri.GetFieldValue("BANK_NAME")
      D.BANK_BRANCH = Ri.GetFieldValue("BANK_BRANCH")
      D.BRANCH_NAME = Ri.GetFieldValue("BRANCH_NAME")
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If PostType = WAITING_CLEAR Then
         Call m_CashTran.SetFieldValue("FROM_DATE", uctlFromDate.ShowDate)
         Call m_CashTran.SetFieldValue("TO_DATE", uctlDocumentDate.ShowDate)
         Call m_CashTran.SetFieldValue("BANK_FLAG", "N")
         Call m_CashTran.SetFieldValue("POST_FLAG", "N")
         Call m_CashTran.QueryData(17, m_Rs, ItemCount)
      ElseIf PostType = PASSED_CLEAR Then
         Call m_CashTran.SetFieldValue("FROM_DATE", uctlFromDate.ShowDate)
         Call m_CashTran.SetFieldValue("TO_DATE", uctlDocumentDate.ShowDate)
         Call m_CashTran.SetFieldValue("BANK_FLAG", "N")
         Call m_CashTran.SetFieldValue("POST_FLAG", "Y")
         Call m_CashTran.QueryData(17, m_Rs, ItemCount)
      ElseIf PostType = POST_CLEAR Then
         m_CashTran.FROM_DATE = uctlFromDate.ShowDate
         m_CashTran.TO_DATE = uctlDocumentDate.ShowDate
         m_CashTran.BANK_FLAG = "Y"
         m_CashTran.POST_FLAG = "N"
         m_CashTran.BANK_ACCOUNT = AccountID
         Call m_CashTran.QueryDataReport(2, m_Rs, ItemCount)
      End If
...
Dim CDP As CCashDocPost
   ...
   For Each D In m_TempCol2
      ...
      CDP.Flag = "A"
      Call CDP.SetFieldValue("CHEQUE_ID", D.CHEQUE_ID)
      Call CDP.SetFieldValue("CHEQUE_DATE", D.CHEQUE_DATE)
      Call CDP.SetFieldValue("CHEQUE_NO", D.CHEQUE_NO)
      Call CDP.SetFieldValue("CHEQUE_AMOUNT", D.CHEQUE_AMOUNT)
      Call CDP.SetFieldValue("BANK_ID", D.BANK_ID)
      Call CDP.SetFieldValue("BANK_NAME", D.BANK_NAME)
      Call CDP.SetFieldValue("BANK_BRANCH", D.BANK_BRANCH)
      Call CDP.SetFieldValue("BRANCH_NAME", D.BRANCH_NAME)
                     
      Call CDP.SetFieldValue("POST_TYPE", PostType)
      
      Call TempCollection.add(CDP)
      End If
   Next D
End Sub
...
Private Sub Form_Activate()
   ...
   If Not m_HasActivate Then
      ...
      If (ShowMode = SHOW_EDIT) Or (ShowMode = SHOW_VIEW_ONLY) Then
         m_CashTran.QueryFlag = 1
         Call QueryData(True)
      ElseIf ShowMode = SHOW_ADD Then
         m_CashTran.QueryFlag = 0
         Call QueryData(True)
      End If
