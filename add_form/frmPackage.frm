...
Dim OKClick As Boolean
   ...
   frmAddEditPackage.HeaderText = MapText("เพิ่มข้อมูลการตั้งราคาสินค้า")
...
Dim ID As Long
   ...
   If Not glbDaily.DeletePackage(m_Package, IsOK, True, glbErrorLog) Then
      Call m_Package.SetFieldValue("PACKAGE_ID", -1)
...
Dim OKClick As Boolean
   ...
   frmAddEditPackage.HeaderText = MapText("แก้ไขข้อมูลการตั้งราคาสินค้า")
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      Call m_Package.SetFieldValue("ORDER_BY", cboOrderBy.ItemData(Minus2Zero(cboOrderBy.ListIndex)))
      Call m_Package.SetFieldValue("ORDER_TYPE", cboOrderType.ItemData(Minus2Zero(cboOrderType.ListIndex)))
...
Dim OKClick As Boolean
   ...
   If lMenuChosen = 1 Then
      Set Ms = New CPackage
      Call Ms.SetFieldValue("PACKAGE_ID", TempID1)
      Call glbDaily.CopyPackage(Ms, IsOK, True, glbErrorLog)
      Call QueryData(True)
      Set Ms = Nothing
...
Dim RealIndex As Long
   ...
   Values(1) = m_TempPackage.GetFieldValue("PACKAGE_ID")
   Values(2) = m_TempPackage.GetFieldValue("PACKAGE_NO")
   Values(3) = m_TempPackage.GetFieldValue("PACKAGE_DESC")
