...
Begin VB.Form frmAddReceiptEditItem 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddReceiptEditItem.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3285
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin PorkShop.uctlDate uctlDocumentDate 
         ...
         _ExtentY        =   714
      End
      Begin PorkShop.uctlTextBox txtCashDiscountPercent 
         Height          =   435
         Left            =   1680
         TabIndex        =   11
         Top             =   720
         ...
         _ExtentY        =   767
      End
      Begin PorkShop.uctlTextBox txtCashDiscountAmount 
         Height          =   435
         Left            =   4680
         TabIndex        =   13
         Top             =   720
         ...
         _ExtentY        =   767
      End
      Begin PorkShop.uctlTextBox txtLeftDiscount 
         Height          =   435
         Left            =   9750
         TabIndex        =   15
         Top             =   720
      ...
      Begin PorkShop.uctlTextBox txtPaidAmount 
         ...
         _ExtentY        =   767
      End
      Begin PorkShop.uctlTextBox txtLeftPaid 
         Height          =   435
         Left            =   4680
         TabIndex        =   19
         Top             =   1200
      ...
      Begin Threed.SSCommand cmdNext 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptEditItem.frx":08CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptEditItem.frx":0BE4
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddReceiptEditItem"
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtDocumentNo.Text = BD.DOCUMENT_NO
         uctlDocumentDate.ShowDate = BD.DOCUMENT_DATE
         txtLeft.Text = BD.PAY_AMOUNT
         txtPaidAmount.Text = BD.PAID_AMOUNT
...
Dim RealIndex As Long
   ...
   BD.PAID_AMOUNT = txtPaidAmount.Text
