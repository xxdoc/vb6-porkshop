...
Begin VB.Form frmAddEditMaster1 
   ...
   Begin Threed.SSFrame Frame1 
      ...
      Begin PorkShop.uctlTextLookup uctlCustomerLookup 
         ...
         _ExtentY        =   767
      End
      Begin PorkShop.uctlTextBox txtShortCode 
         Height          =   435
         Left            =   6960
         TabIndex        =   3
         Top             =   660
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ItemCount > 0 Then
         ...
         If MasterKey = "26-X" Then   'บัญชีธนาคาร
...
'   End If
   ...
   If MasterKey = MASTER_BANK_ACCOUNT & "-X" Then
      m_MasterRef.PARENT_EX_ID4 = uctlSale.MyCombo.ItemData(Minus2Zero(uctlSale.MyCombo.ListIndex))   'ธนาคาร
      m_MasterRef.PARENT_EX_ID5 = uctlCustomerLookup.MyCombo.ItemData(Minus2Zero(uctlCustomerLookup.MyCombo.ListIndex)) 'สาขาธนาคาร
   End If
