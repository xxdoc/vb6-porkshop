...
Dim ID As Long
   ...
   If Not glbDaily.DeleteUserGroup(m_UserGroup, IsOK, True, glbErrorLog) Then
      Call m_UserGroup.SetFieldValue("GROUP_ID", -1)
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      Call m_UserGroup.SetFieldValue("ORDER_BY", cboOrderBy.ItemData(Minus2Zero(cboOrderBy.ListIndex)))
      Call m_UserGroup.SetFieldValue("ORDER_TYPE", cboOrderType.ItemData(Minus2Zero(cboOrderType.ListIndex)))
      Call m_UserGroup.SetFieldValue("GROUP_ID", -1)
...
Dim RealIndex As Long
   ...
   Values(1) = m_TempUserGroup.GetFieldValue("GROUP_ID")
   Values(2) = m_TempUserGroup.GetFieldValue("GROUP_NAME")
   Values(3) = m_TempUserGroup.GetFieldValue("MAX_USER")
   Values(4) = m_TempUserGroup.GetFieldValue("GROUP_DESC")
   Values(5) = m_TempUserGroup.GetFieldValue("GROUP_STATUS")
   Exit Sub
