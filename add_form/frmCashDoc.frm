...
Begin VB.Form frmCashDoc 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin PorkShop.uctlDate uctlChequeDate 
         Height          =   405
         Left            =   6180
         TabIndex        =   1
         Top             =   990
      ...
      End
      Begin PorkShop.uctlTextBox txtChequeNo 
         Height          =   435
         Left            =   1860
         TabIndex        =   0
         Top             =   960
...
Dim TempStr As String
   ...
   frmAddEditCashDoc.DocumentType = DocumentType
   frmAddEditCashDoc.HeaderText = MapText("เพิ่มข้อมูล" & CashDocTypeToText(DocumentType))
...
Dim TempStr As String
   ...
   frmAddEditCashDoc.DocumentType = DocumentType
   frmAddEditCashDoc.HeaderText = MapText("แก้ไขข้อมูล" & CashDocTypeToText(DocumentType))
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblCustomerCode, MapText("เลขที่เอกสาร"))
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่บัญชี"))
