...
Begin VB.Form frmProcssCommit 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSPanel pnlHeader 
         ...
         PictureBackgroundStyle=   2
      End
      Begin Rebate.uctlTextBox txtPercent 
         Height          =   465
         Left            =   1980
         TabIndex        =   4
         Top             =   2280
      ...
      Begin Rebate.uctlDate uctlToDate 
         ...
         _ExtentY        =   714
      End
      Begin Rebate.uctlTextLookup uctlProductLookup 
         Height          =   435
         Left            =   1980
         TabIndex        =   2
         Top             =   1440
...
Dim Cm As CCapitalMovement
   ...
   Call GetDocItemIDLinkLotItemID(DocLinkLot, -1, , , Lt.PART_ITEM_ID, "N", FromDate, ToDate)
...
'   Dim strDate As String
   ...
   ''debug.print (strDate)
   Call LoadCapitalMovementLocation(CapitalCollold, DateAdd("D", -1, FromDate), DateAdd("D", -1, FromDate), Cm.PART_ITEM_ID)  'ราคาเฉลี่ยของสินค้า ณ วัน ที่ล่าสุด ในแต่ละคลัง
   
   Call CopyOldToMovement(CapitalCollold, CapitalCollmovement)
   
   Call LoadLeftAmountLocation(BalanceCollold, , DateAdd("D", -1, FromDate), , , , Lt.PART_ITEM_ID)                                  'Load ข้อมูลของปริมาณ ณ วัน ที่ล่าสุด ในแต่ละคลัง
   ...
   While Not m_Rs.EOF
      I = I + 1
      If Not (Parent Is Nothing) Then
         Parent.Value = MyDiff(I, m_Rs.RecordCount) * 75
